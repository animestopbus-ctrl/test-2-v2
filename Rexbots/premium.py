...
async def my_plan(client: Client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📞 Contact Admin", url="https://t.me/RexBots_Official")]
    ])
...
async def show_premium_plans(message_or_query):
    ...
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("💳 Buy Premium Now", url="https://t.me/RexBots_Official")],
